...
Vue.prototype.$q = {
  ...
  dialog : {
     ...
     * @param {{class : String|Array|Object, style : String|Array|Object, title : String, message : String, position : 'top'|'right'|'bottom'|'left'|'standard', prompt : {model : Array|String, type : String}, options : {type : 'radio'|'checkbox'|'toggle', model : Array, items : Array}, ok : String|{...props : *}|Boolean, cancel : String|{...props : *}|Boolean, stackButtons : Boolean, color : String, dark : Boolean, persistent : Boolean, no-esc-dismiss : Boolean, no-backdrop-dismiss : Boolean, no-route-dismiss : Boolean, seamless : Boolean, maximized : Boolean, full-width : Boolean, full-height : Boolean, transition-show : String, transition-hide : String, component : *, root : Object}} opts Dialog options
     * @returns {{onOk : Function, onCancel : Function, onDismiss : Function, hide : Function}} Chainable Object
     */
    create (opts) {}
  },
